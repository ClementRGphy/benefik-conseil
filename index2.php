...
-webkit-transition: all 0.45s ease-in-out;
 ...
 @media screen and (max-width:950px){
                ...
                <div id="central">
                    ...
                    <div id="container">
                        <div id="titres" style="">
                            <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1 titre" id="titre1">Benefik <span style="color:#333377">Conseil</span>™</h1>

                            <h2 class="titre" id="titre2"> Une gamme complète de produits et services indispensables à votre projet.</h2>
                        </div>

                        
                       <?php include('titreapparition.php');?>
...
<!-- 	                <p class="mbr-text pb-3 mbr-fonts-style display-5">
					...
					<div id="liens">
		            	...
		            	<div class="lienCentre" onmouseover="titre_appear(3)"
...
function titre_desappear(id){
    ...
    document.getElementById('titreapparition'+id).style.transform='translate(-100%, 0px)';
