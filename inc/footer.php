<section class="footer_sec" id="footer1-2" style="background-color:black;">
    ...
    <div class="container2" style="text-align:center;padding-top:20px;">
        <div  style="color:white;" >
            ...
            <div >
                ...
                <p class="mbr-text">
                    ...
                    <br><a class="text-primary" href="https://https://www.basik-phyto.com">Basik-Phyto</a>
                    <br><a class="text-primary" href="https://www.holistik.shop/">Holistik</a>
                </p>
            </div>
        </div>
        <div class="footer-lower">
            ...
            <div class="media-container-row mbr-white" style="display:none">
